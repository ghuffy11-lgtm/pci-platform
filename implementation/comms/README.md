...
|---|---|---|---|
| **MSG-0072** | **ADR promotion gap after MSG-0071** | **OPEN** — **decision needed.** MSG-0071 accepted **all six** ADRs and directed promotion, but only **ADR-0017** is in `docs/decisions/`; ADR-0018…0022 remain drafts. Indexes and drafts reconciled to record the acceptance; **promotion itself was NOT performed** — it is the act that confers authority and no READY task authorizes it | [MSG-0072-adr-promotion-gap.md](MSG-0072-adr-promotion-gap.md) |
