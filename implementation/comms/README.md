...
|---|---|---|---|
| **MSG-0057** | **Reconciling the EPA rulings — three findings** | **OPEN** — all fourteen decisions annotated inline in EPA-0003; **F1** cross-language grounding (Arabic answer vs English source) needs an explicit scope/fallback ruling; **F2** unauthenticated access has no accepted authority and names an undefined classification value — recommend deferring; **F3** AD integration must terminate at an OIDC/OAuth2 boundary per accepted ADR-0007; **F4** fourth message-number collision | [MSG-0057-epa-ruling-reconciliation-findings.md](MSG-0057-epa-ruling-reconciliation-findings.md) |
