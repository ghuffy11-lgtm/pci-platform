...
|---|---|---|---|
| **MSG-0074** | **TASK-0025 queue reconciliation** | **OPEN** — informational. TASK-0025 reconciled as the **single READY task** after verifying prerequisites. **No separate TASK-0025 spec file exists**; MSG-0073 plus the queue section are the specification, and the section carries the promotion convention verified from the ADR-0015 and ADR-0017 precedents | [MSG-0074-task-0025-queue-reconciliation.md](MSG-0074-task-0025-queue-reconciliation.md) |
