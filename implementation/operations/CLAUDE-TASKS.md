...
| TASK-0040 | **Encode Q12 in EPA-0006 §4.6 S7 — index-cursor placement must be exercised** | **READY** | MSG-0125 AUTHORIZED, MSG-0124 (Q12), MSG-0123 evidence, TASK-0034 precedent | — | none — **criterion update only**, additive and declared; no ADR change, nothing selected, **verdicts preserved** | Claude Code |
