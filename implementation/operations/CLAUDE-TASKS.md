...
| TASK-0049 | **Promote TASK-0046's topology/durability evidence into EPA-0006 §4.19** | **READY** | **MSG-0161b** (Q18 = **YES**) AUTHORIZED, ruling consequence 1; the Lead's committed task definition [`TASK-0049-epa-0006-419-promotion.md`](TASK-0049-epa-0006-419-promotion.md) (`9f8f416`); **MSG-0162 §5** (section number fixed, sequencing); **MSG-0158** (the evidence and its boundary); TASK-0048 COMPLETE | — **not yet executed** | Promote the TASK-0046 evidence as **EPA-0006 §4.19**, additive, exactly as the Lead's task file defines it. **Where the task file and this row differ, the FILE WINS and the difference is reported.** **Documentation, not measurement** — it records evidence that already exists; **if the promotion appears to need a number MSG-0158 does not contain, STOP and refer it rather than measuring.** **The MSG-0158 evidence boundary must survive into §4.19's own text**: one subject, one allocator, one build; **no generalization to an engine class**, no engine selected, no gate changed, no verdict moved. **Promotion clears nothing.** **Do not restate TASK-0048's N6 findings as part of §4.19** — those belong to MSG-0163 and to their own record. **Numbering: MSG-0164 is taken by the Lead's verification record; use MSG-0165 or later.** **Stop if `origin/main` moves mid-run** | Claude Code |
