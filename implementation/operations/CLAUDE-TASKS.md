...
| TASK-0027 | **A-SURVEY (n=1) — inspect the approved/synthetic corpus** | **READY** | TASK-0026 COMPLETE (PARTIAL), MSG-0080, MSG-0083 (corpus read permission), corpus readable by the runner | — | none — BLK-0010 cleared by MSG-0083 option A; **n=1, no distributional claims**; **the PDF must never enter the repository** | Claude Code |
