...
| EPA-0003 | Employee Policy Assistant — required architecture-lead decisions | **ALL FOURTEEN RULED** 2026-08-21 (MSG-0056a/b); three reconciliation findings open (MSG-0057) | TASK-0021, MSG-0054 |

Read them in that order. EPA-0003 is the one that needs an answer; EPA-0001 and EPA-0002 are only
executable once it has one.
